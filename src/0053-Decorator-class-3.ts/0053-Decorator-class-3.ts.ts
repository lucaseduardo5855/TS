...
function outroDecorator(param1: string, param2: string) {
  return function (target: Constructor) {
    console.log('Sou o 2 decorador' + ' ' + param1 + ' ' + param2);
    return target;
  };
}

@outroDecorator('NEYMAR TEM Q IR P COPA', 'lucas') //SEGUNDO DECORATOR
